...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Property.reception_count'
        db.add_column('life_property', 'reception_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Property.reception_count'
        db.delete_column('life_property', 'reception_count')
