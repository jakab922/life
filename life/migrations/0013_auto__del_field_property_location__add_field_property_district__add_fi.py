...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Property.district'
        db.add_column('life_property', 'district', self.gf('django.db.models.fields.related.ForeignKey')(default='a', to=orm['life.District']), keep_default=False)

        # Adding field 'CityPart.cp_id'
        db.add_column('life_citypart', 'cp_id', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Property.district'
        db.delete_column('life_property', 'district_id')

        # Deleting field 'CityPart.cp_id'
        db.delete_column('life_citypart', 'cp_id')
