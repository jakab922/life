...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'TestimonialTranslation.langauge'
        db.delete_column('life_testimonialtranslation', 'langauge_id')

        # Adding field 'TestimonialTranslation.language'
        db.add_column('life_testimonialtranslation', 'language', self.gf('django.db.models.fields.related.ForeignKey')(default='uk', to=orm['life.Language']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'TestimonialTranslation.langauge'
        db.add_column('life_testimonialtranslation', 'langauge', self.gf('django.db.models.fields.related.ForeignKey')(default='asdf', to=orm['life.Language']), keep_default=False)

        # Deleting field 'TestimonialTranslation.language'
        db.delete_column('life_testimonialtranslation', 'language_id')
