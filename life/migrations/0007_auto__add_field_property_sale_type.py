...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Property.sale_type'
        db.add_column('life_property', 'sale_type', self.gf('django.db.models.fields.CharField')(default='S', max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Property.sale_type'
        db.delete_column('life_property', 'sale_type')
