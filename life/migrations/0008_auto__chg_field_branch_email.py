...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Branch.email'
        db.alter_column('life_branch', 'email', self.gf('django.db.models.fields.EmailField')(max_length=50))


    def backwards(self, orm):
        
        # Changing field 'Branch.email'
        db.alter_column('life_branch', 'email', self.gf('django.db.models.fields.CharField')(max_length=30))
