...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PropertyDescription.short_desc'
        db.delete_column('life_propertydescription', 'short_desc')


    def backwards(self, orm):
        
        # Adding field 'PropertyDescription.short_desc'
        db.add_column('life_propertydescription', 'short_desc', self.gf('django.db.models.fields.TextField')(default=0), keep_default=False)
